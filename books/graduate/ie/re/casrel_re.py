...
# 加载数据集
train_data = load_data('../data/re/duie/train_data.json')
valid_data = load_data('../data/re/duie/dev_data.json')
predicate2id, id2predicate = {}, {}

with open('../data/re/duie/all_50_schemas') as f:
    for l in f:
        l = json.loads(l)
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            train_model.save_weights('../checkpoint/re/best_model_casrel.weights')
...
if __name__ == '__main__':
    ...
    if do_predict:
      train_model.load_weights('../checkpoint/re/best_model_casrel.weights')
      predict(valid_data)